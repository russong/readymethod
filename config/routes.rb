Infoready::Application.routes.draw do
  ...
  devise_for :users, :controllers => { :sessions => 'users/sessions', :registrations => 'users/registrations'}, :skip => [:sessions] do
  ...
  resources :map do
    collection do 
      match 'stage/:id' => "map#stage", as: "stage"
      match 'activity/:id' => "map#activity", as: "activity"
    end
    #map/stage/1
